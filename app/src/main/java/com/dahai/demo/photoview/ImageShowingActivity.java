...
public class ImageShowingActivity extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener {
    ...
    public final static String ARGS_TRANSITION_BEFORE_BACKGROUND_COLOR = "ARGS_TRANSITION_BEFORE_BACKGROUND_COLOR";
    ...
    void extractAndApplyColor(@NonNull final Bitmap bitmap) {
        ...
        int semiTransparentColor = (BACKGROUND_COLOR_NAVIGATION_ALPHA & 0xff) << 24 | (currentBackgroundColor & 0x00ffffff);
        ...
        sharedElement.getViewTreeObserver().addOnPreDrawListener(
            new ViewTreeObserver.OnPreDrawListener() {
                ...
                public boolean onPreDraw() {
                    ...
                    ActivityCompat.startPostponedEnterTransition(ImageShowingActivity.this);
                    return true;
                }
            });
    }
