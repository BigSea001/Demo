package com.dahai.demo.viewpager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageScrolled(final int position, float positionOffset, int positionOffsetPixels) {
                ...
                Log.e("HHH", "onPageScrolled: " + positionOffset );
...
//                landingBGView.setBackgroundColor(shades.generate());
    ...
    public class ViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            View itemView = getLayoutInflater().inflate(R.layout.item_viewpager, container, false);
    ...
    public class CustomPageTransformer implements ViewPager.PageTransformer {
        ...
        public void transformPage(View view, float position) {
            ...
            Log.e("HHH", "transformPage: " + position );
